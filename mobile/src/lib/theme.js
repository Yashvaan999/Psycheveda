...
export const hpaPalettes = {
  ...
  twilight: {
    ...
    description: 'Midday-to-dusk transition — softened tones for grounded reset.',
  ...
  melatonin_pm: {
    ...
    description: 'Evening fall — cool, sub-luminal hues that invite parasympathetic rest.',
